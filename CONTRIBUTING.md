# Contributing to hzb-catalysisLabs-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
hzb-catalysisLabs-schema. These guidelines are not strict rules.
...
The hzb-catalysisLabs-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the hzb-catalysisLabs-schema technical leads
...
[issues]: https://github.com/https://github.com/HZB-CE-DataSchemas//hzb-catalysisLabs-schema/issues/
[pulls]: https://github.com/https://github.com/HZB-CE-DataSchemas//hzb-catalysisLabs-schema/pulls/
